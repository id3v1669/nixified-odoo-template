...
Initialization creates a Git repository on `master` and stages the generated
files without committing them. Keep runtime files such as `.env` untracked: Nix uses Git's
