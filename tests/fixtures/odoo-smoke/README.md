...
compatibility constraints as generated projects. Odoo 17 uses Python 3.11 and
setuptools below 81 for `pkg_resources`. Odoo 18 uses Python 3.12.
Odoo 19 uses Python 3.14 with the
...
the corresponding `checks.x86_64-linux.odoo17`, `odoo18`, or `odoo19` output. Dependency
